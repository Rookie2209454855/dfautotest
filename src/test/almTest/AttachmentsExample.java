...
import almTest.infrastructure.Assert;
import almTest.infrastructure.Constants;
import almTest.infrastructure.Response;
import almTest.infrastructure.RestConnector;
...
public class AttachmentsExample {
    ...
    public void attachmentsExample(final String serverUrl, final String domain,
                                   final String project, String username, String password)throws Exception {
        ...
        */
        ...
        boolean loginResponse =
                login.login("http://192.168.57.26:5174/qcbin/api/authentication/sign-in","fengtiepeng","a123456");
        ...
        map.put("severity","2 - 中");
        map.put("detected-by","fengtiepeng");
        map.put("creation-time","2012-2-2");
