...
public class AuthenticateLoginLogoutExample {
    ...
    public void authenticateLoginLogoutExample(final String serverUrl, final String domain, final String project, String username,
