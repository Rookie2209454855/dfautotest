...
public class RestConnector {
    ...
    public String buildEntityCollectionUri(String entityType) {
        return buildUrl("api/domains/"
                + domain
                + "/projects/"
                + project
    ...
    public Response httpPost1(String url, String data, Map<String,
            String> headers) throws Exception {

        return doHttp1("POST", url, null, data, headers, cookies);
    }
    ...
    private Response doHttp1(String type, String url, String queryString, String data, Map<String, String> headers,
                            Map<String, String> cookies) throws Exception {
        ...
        prepareHttpRequest1(con, headers, data, cookieString);
        con.connect();
        Response ret = retrieveHtmlResponse(con);
    ...
    private void prepareHttpRequest1(HttpURLConnection con, Map<String, String> headers, String bytes,
                                    String cookieString) throws IOException {
